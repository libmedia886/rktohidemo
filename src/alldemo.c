...
#define HIGHLIGHT_SUPPRESS_THRESHOLD_LOW 0.64f
#define HIGHLIGHT_SUPPRESS_THRESHOLD_HIGH 0.90f
#define HIGHLIGHT_SUPPRESS_KNEE 0.72f
#define HIGHLIGHT_SUPPRESS_RATIO 0.14f
#define HIGHLIGHT_SUPPRESS_STRENGTH 0.78f
#define HIGHLIGHT_SUPPRESS_CHROMA_LOW 0.05f
#define HIGHLIGHT_SUPPRESS_CHROMA_HIGH 0.44f
...
static const char *module_flow_note(const char *name) {
    ...
    if (strcasecmp(name, "HIGHLIGHT_SUPPRESS") == 0) return "数据流：合成NV12强反光场景 -> soft-knee高光压制 -> 输入/输出对比。";
...
static const char *module_showcase_note(const char *name) {
    ...
    if (strcasecmp(name, "HIGHLIGHT_SUPPRESS") == 0) return "展示重点：白色刺眼高光变柔和，同时背景和有色目标不过度变暗。";
